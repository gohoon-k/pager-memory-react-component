...
exports.generatePagerController = void 0;
var jsx_runtime_1 = require("react/jsx-runtime");
// Wow!! So spaghetti!! So delicious!!!
var react_1 = __importStar(require("react"));
var styled_components_1 = __importDefault(require("styled-components"));
var DefaultPageTransitionMethod_1 = __importDefault(require("./transition_methods/DefaultPageTransitionMethod"));
/** Creates Pager.
 *
...
var PagerMemory = function (props) {
    ...
    var _g = react_1.useState({ width: 0, height: 0 }), absoluteDimension = _g[0], setAbsoluteDimension = _g[1];
    ...
    var pageLength = react_1.useMemo(function () { return react_1.default.Children.count(props.children); }, [props.children]);
    var childLength = react_1.useMemo(function () { return props.overscroll ? pageLength + 2 : pageLength; }, [pageLength, props.overscroll]);
    var index2position = react_1.useCallback(function (index) {
        return index - (props.overscroll ? 1 : 0);
    }, [props.overscroll]);
    var position2index = react_1.useCallback(function (position) {
        return position + (props.overscroll ? 1 : 0);
    }, [props.overscroll]);
    var transitionData = react_1.useMemo(function () {
        return {
    ...
    var pageStyles = react_1.useMemo(function () {
        if (pageLength === 0)
            return [];
        var styles = [];
    ...
    var scrollIt = react_1.useCallback(function (value, newScroll) {
        if (!element.current)
            return;
        if (props.lockPager)
            return;
    ...
    var animateIt = react_1.useCallback(function (index) {
        if (props.lockPager)
            return;
    ...
    var select = react_1.useCallback(function (position, animate) {
        var _a, _b;
        if (props.lockPager)
            return;
    ...
    var next = react_1.useCallback(function (animate) {
        var _a, _b;
    ...
    var previous = react_1.useCallback(function (animate) {
        var _a, _b;
        (_b = (_a = props.controller) === null || _a === void 0 ? void 0 : _a.select) === null || _b === void 0 ? void 0 : _b.call(null, index2position(data.current.selected - 1), animate);
    }, [data, index2position, (_d = props.controller) === null || _d === void 0 ? void 0 : _d.select]);
    var down = react_1.useCallback(function (x, y) {
        var _a, _b;
    ...
    var move = react_1.useCallback(function (x, y) {
        var _a, _b;
    ...
    var up = react_1.useCallback(function () {
        if (data.current.animating || !data.current.pointer.enabled)
            return;
    ...
    if (pageLength === 0)
        return jsx_runtime_1.jsx(PagerElement, { ref: element, style: { display: "none" } }, void 0);
    if (absoluteDimension.width === 0 || absoluteDimension.height === 0) {
        return jsx_runtime_1.jsx(PagerElement, { ref: element, style: { width: props.dimension.width, height: props.dimension.height } }, void 0);
    }
    var renderTargets = [];
    if (props.overscroll)
        renderTargets.push(jsx_runtime_1.jsx(PagerItem, { style: __assign({}, pageStyles[0]) }, "PagerMemory_OverscrollDummy_Start"));
    renderTargets.push.apply(renderTargets, (react_1.default.Children.map(props.children, function (page, position) {
        return jsx_runtime_1.jsx(PagerItem, __assign({ style: __assign({}, pageStyles[position2index(position)]) }, { children: page }), "PagerMemory_Page_" + position);
    })));
    if (props.overscroll)
        renderTargets.push(jsx_runtime_1.jsx(PagerItem, { style: __assign({}, pageStyles[pageLength + 1]) }, "PagerMemory_OverscrollDummy_End"));
    return jsx_runtime_1.jsx(PagerElement, __assign({ ref: element, style: { width: props.dimension.width, height: props.dimension.height } }, { children: renderTargets }), void 0);
};
PagerMemory.defaultProps = {
    transitionMethod: new DefaultPageTransitionMethod_1.default(),
    pointerEvents: true
};
var PagerElement = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  overflow: hidden;\n  user-select: none;\n  opacity: 0;\n"], ["\n  overflow: hidden;\n  user-select: none;\n  opacity: 0;\n"])));
var PagerItem = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n  height: 100%;\n  padding: 0;\n  margin: 0;\n  overflow: auto;\n"], ["\n  position: relative;\n  width: 100%;\n  height: 100%;\n  padding: 0;\n  margin: 0;\n  overflow: auto;\n"
...
var generatePagerController = function () {
    return {
        select: function () {
        },
        next: function () {
...
exports.generatePagerController = generatePagerController;
exports.default = PagerMemory;
